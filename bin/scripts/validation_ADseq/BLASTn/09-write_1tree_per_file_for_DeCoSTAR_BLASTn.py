...
###         (DECOSTAR/DATA_DeCoSTAR/GENE_TREES/ROOTED/rooted_trees_DeCoSTAR_WGtopo.nwk)
###      2- Directory containing RAW gene trees of Rob Waterhouse (to name gene trees)
###         (DECOSTAR/DATA_DeCoSTAR/INPUT_DATA/OG_CDS_newtrees)
###      3- OUTPUT directory where gene tree files will be stored
###         (Anopheles-Nov2016/data/DeCoSTAR_Anopheles_Xtopo_gene_trees)
###         (Anopheles-Nov2016/data/DeCoSTAR_Anopheles_WGtopo_gene_trees)
###      4- Path written in gene trees file for DeCo*
###         (data/DeCoSTAR_Anopheles_Xtopo_gene_trees)
###         (data/DeCoSTAR_Anopheles_WGtopo_gene_trees)
###      5- OUTPUT trees file for DeCo*
###         (Anopheles-Nov2016/data/distrib_DeCoSTAR_Anopheles_Xtopo_gene_trees.txt)
###         (Anopheles-Nov2016/data/distrib_DeCoSTAR_Anopheles_WGtopo_gene_trees.txt)
...
###
###   Name: 09-write_1tree_per_file_for_DeCoSTAR_BLASTn.py  Author: Yoann Anselmetti
###   Creation date: 2016/09/02                             Last modification: 2016/11/17
###
